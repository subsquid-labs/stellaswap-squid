...
import {ABI_JSON} from './0x96bef4719ae7c053113292e6aa7fc36e62b243e8.abi'
...
export const functions = {
    ...
    setStellaPerAvax: new Func<[_stellaPerAvax: ethers.BigNumber], {_stellaPerAvax: ethers.BigNumber}, []>(
        abi, '0x6e6b4699'
    ),
    ...
    stellaPerAvax: new Func<[], {}, ethers.BigNumber>(
        abi, '0x67e3c61b'
    ),
    totalAvaxCommited: new Func<[], {}, ethers.BigNumber>(
        abi, '0x5fecd9fc'
    ),
...
export class Contract extends ContractBase {
    ...
    avax(): Promise<string> {
        return this.eth_call(functions.avax, [])
    }
    ...
    stellaPerAvax(): Promise<ethers.BigNumber> {
        return this.eth_call(functions.stellaPerAvax, [])
    }

    totalAvaxCommited(): Promise<ethers.BigNumber> {
        return this.eth_call(functions.totalAvaxCommited, [])
    }
