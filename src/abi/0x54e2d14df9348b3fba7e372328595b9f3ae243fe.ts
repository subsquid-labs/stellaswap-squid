...
import {ABI_JSON} from './0x54e2d14df9348b3fba7e372328595b9f3ae243fe.abi'
...
export const functions = {
    ...
    add: new Func<[_allocPoint: ethers.BigNumber, _lpToken: string, _depositFeeBP: number, _harvestInterval: ethers.BigNumber, _withUpdate: boolean, _lockDownDuration: ethers.BigNumber], {_allocPoint: ethers.BigNumber, _lpToken: string, _depositFeeBP: number, _harvestInterval: ethers.BigNumber, _withUpdate: boolean, _lockDownDuration: ethers.BigNumber}, []>(
        abi, '0xcaa84cd1'
    ),
    ...
    poolInfo: new Func<[_: ethers.BigNumber], {}, ([lpToken: string, allocPoint: ethers.BigNumber, lastRewardBlock: ethers.BigNumber, accStellaPerShare: ethers.BigNumber, depositFeeBP: number, harvestInterval: ethers.BigNumber, totalLp: ethers.BigNumber, lockDownDuration: ethers.BigNumber] & {lpToken: string, allocPoint: ethers.BigNumber, lastRewardBlock: ethers.BigNumber, accStellaPerShare: ethers.BigNumber, depositFeeBP: number, harvestInterval: ethers.BigNumber, totalLp: ethers.BigNumber, lockDownDuration: ethers.BigNumber})>(
        abi, '0x1526fe27'
    ),
    ...
    set: new Func<[_pid: ethers.BigNumber, _allocPoint: ethers.BigNumber, _depositFeeBP: number, _harvestInterval: ethers.BigNumber, _lockDownDuration: ethers.BigNumber, _withUpdate: boolean], {_pid: ethers.BigNumber, _allocPoint: ethers.BigNumber, _depositFeeBP: number, _harvestInterval: ethers.BigNumber, _lockDownDuration: ethers.BigNumber, _withUpdate: boolean}, []>(
        abi, '0xcc197732'
    ),
    ...
    withdrawableAmount: new Func<[_pid: ethers.BigNumber, account: string], {_pid: ethers.BigNumber, account: string}, ethers.BigNumber>(
        abi, '0x7831a74f'
    ),
}
...
export class Contract extends ContractBase {
    ...
    withdrawableAmount(_pid: ethers.BigNumber, account: string): Promise<ethers.BigNumber> {
        return this.eth_call(functions.withdrawableAmount, [_pid, account])
    }
}
