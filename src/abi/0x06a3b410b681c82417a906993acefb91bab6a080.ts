...
import {ABI_JSON} from './0x06a3b410b681c82417a906993acefb91bab6a080.abi'
...
export const functions = {
    ...
    enter: new Func<[_stellaAmount: ethers.BigNumber], {_stellaAmount: ethers.BigNumber}, []>(
        abi, '0xa59f3e0c'
    ),
    increaseAllowance: new Func<[spender: string, addedValue: ethers.BigNumber], {spender: string, addedValue: ethers.BigNumber}, boolean>(
        abi, '0x39509351'
    ),
    leave: new Func<[xStellaAmount: ethers.BigNumber], {xStellaAmount: ethers.BigNumber}, []>(
        abi, '0x67dfd4c9'
    ),
