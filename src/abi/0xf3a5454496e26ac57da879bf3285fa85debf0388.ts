...
import {ABI_JSON} from './0xf3a5454496e26ac57da879bf3285fa85debf0388.abi'

export const abi = new ethers.utils.Interface(ABI_JSON);

export const events = {
    Add: new LogEvent<([pid: ethers.BigNumber, allocPoint: ethers.BigNumber, lpToken: string, depositFeeBP: number, harvestInterval: ethers.BigNumber, rewarders: Array<string>] & {pid: ethers.BigNumber, allocPoint: ethers.BigNumber, lpToken: string, depositFeeBP: number, harvestInterval: ethers.BigNumber, rewarders: Array<string>})>(
        abi, '0x5ed295c4f5af5aeb1ccd905e1cd55a86ab3bb9fc1fe2346ff64ac47dbef36661'
    ),
    ...
    EmissionRateUpdated: new LogEvent<([caller: string, previousValue: ethers.BigNumber, newValue: ethers.BigNumber] & {caller: string, previousValue: ethers.BigNumber, newValue: ethers.BigNumber})>(
    ...
    Set: new LogEvent<([pid: ethers.BigNumber, allocPoint: ethers.BigNumber, depositFeeBP: number, harvestInterval: ethers.BigNumber, rewarders: Array<string>] & {pid: ethers.BigNumber, allocPoint: ethers.BigNumber, depositFeeBP: number, harvestInterval: ethers.BigNumber, rewarders: Array<string>})>(
        abi, '0x5ed6f0deef9ab49d02900b40d596df4cd637a2a7fbfa56bbcb377389d3ce8d28'
    ),
    ...
    UpdatePool: new LogEvent<([pid: ethers.BigNumber, lastRewardTimestamp: ethers.BigNumber, lpSupply: ethers.BigNumber, accStellaPerShare: ethers.BigNumber] & {pid: ethers.BigNumber, lastRewardTimestamp: ethers.BigNumber, lpSupply: ethers.BigNumber, accStellaPerShare: ethers.BigNumber})>(
...
export const functions = {
    ...
    add: new Func<[_allocPoint: ethers.BigNumber, _lpToken: string, _depositFeeBP: number, _harvestInterval: ethers.BigNumber, _rewarders: Array<string>], {_allocPoint: ethers.BigNumber, _lpToken: string, _depositFeeBP: number, _harvestInterval: ethers.BigNumber, _rewarders: Array<string>}, []>(
        abi, '0x508593ab'
    ),
    ...
    depositWithPermit: new Func<[pid: ethers.BigNumber, amount: ethers.BigNumber, deadline: ethers.BigNumber, v: number, r: string, s: string], {pid: ethers.BigNumber, amount: ethers.BigNumber, deadline: ethers.BigNumber, v: number, r: string, s: string}, []>(
        abi, '0x515bc323'
    ),
    ...
    pendingTokens: new Func<[_pid: ethers.BigNumber, _user: string], {_pid: ethers.BigNumber, _user: string}, ([addresses: Array<string>, symbols: Array<string>, decimals: Array<ethers.BigNumber>, amounts: Array<ethers.BigNumber>] & {addresses: Array<string>, symbols: Array<string>, decimals: Array<ethers.BigNumber>, amounts: Array<ethers.BigNumber>})>(
        abi, '0xffcd4263'
    ),
    poolInfo: new Func<[_: ethers.BigNumber], {}, ([lpToken: string, allocPoint: ethers.BigNumber, lastRewardTimestamp: ethers.BigNumber, accStellaPerShare: ethers.BigNumber, depositFeeBP: number, harvestInterval: ethers.BigNumber, totalLp: ethers.BigNumber] & {lpToken: string, allocPoint: ethers.BigNumber, lastRewardTimestamp: ethers.BigNumber, accStellaPerShare: ethers.BigNumber, depositFeeBP: number, harvestInterval: ethers.BigNumber, totalLp: ethers.BigNumber})>(
        abi, '0x1526fe27'
    ),
    poolLength: new Func<[], {}, ethers.BigNumber>(
        abi, '0x081e3eda'
    ),
    poolRewarders: new Func<[_pid: ethers.BigNumber], {_pid: ethers.BigNumber}, Array<string>>(
        abi, '0xeff8976b'
    ),
    poolRewardsPerSec: new Func<[_pid: ethers.BigNumber], {_pid: ethers.BigNumber}, ([addresses: Array<string>, symbols: Array<string>, decimals: Array<ethers.BigNumber>, rewardsPerSec: Array<ethers.BigNumber>] & {addresses: Array<string>, symbols: Array<string>, decimals: Array<ethers.BigNumber>, rewardsPerSec: Array<ethers.BigNumber>})>(
        abi, '0x465e81ec'
    ),
    poolTotalLp: new Func<[pid: ethers.BigNumber], {pid: ethers.BigNumber}, ethers.BigNumber>(
        abi, '0x654c9ece'
    ),
    renounceOwnership: new Func<[], {}, []>(
        abi, '0x715018a6'
    ),
    set: new Func<[_pid: ethers.BigNumber, _allocPoint: ethers.BigNumber, _depositFeeBP: number, _harvestInterval: ethers.BigNumber, _rewarders: Array<string>], {_pid: ethers.BigNumber, _allocPoint: ethers.BigNumber, _depositFeeBP: number, _harvestInterval: ethers.BigNumber, _rewarders: Array<string>}, []>(
        abi, '0x2081ccc4'
    ),
    ...
    setTreasuryAddress: new Func<[_treasuryAddress: string], {_treasuryAddress: string}, []>(
        abi, '0x6605bfda'
    ),
    ...
    startTimestamp: new Func<[], {}, ethers.BigNumber>(
        abi, '0xe6fd48bc'
    ),
    stella: new Func<[], {}, string>(
        abi, '0x5e18b5d6'
    ),
    stellaPerSec: new Func<[], {}, ethers.BigNumber>(
        abi, '0x820282c1'
    ),
    ...
    updateAllocPoint: new Func<[_pid: ethers.BigNumber, _allocPoint: ethers.BigNumber], {_pid: ethers.BigNumber, _allocPoint: ethers.BigNumber}, []>(
        abi, '0xeddf9652'
    ),
    updateEmissionRate: new Func<[_stellaPerSec: ethers.BigNumber], {_stellaPerSec: ethers.BigNumber}, []>(
        abi, '0x0ba84cd2'
    ),
...
export class Contract extends ContractBase {
    ...
    pendingTokens(_pid: ethers.BigNumber, _user: string): Promise<([addresses: Array<string>, symbols: Array<string>, decimals: Array<ethers.BigNumber>, amounts: Array<ethers.BigNumber>] & {addresses: Array<string>, symbols: Array<string>, decimals: Array<ethers.BigNumber>, amounts: Array<ethers.BigNumber>})> {
    ...
    poolRewarders(_pid: ethers.BigNumber): Promise<Array<string>> {
        return this.eth_call(functions.poolRewarders, [_pid])
    }

    poolRewardsPerSec(_pid: ethers.BigNumber): Promise<([addresses: Array<string>, symbols: Array<string>, decimals: Array<ethers.BigNumber>, rewardsPerSec: Array<ethers.BigNumber>] & {addresses: Array<string>, symbols: Array<string>, decimals: Array<ethers.BigNumber>, rewardsPerSec: Array<ethers.BigNumber>})> {
        return this.eth_call(functions.poolRewardsPerSec, [_pid])
    }

    poolTotalLp(pid: ethers.BigNumber): Promise<ethers.BigNumber> {
        return this.eth_call(functions.poolTotalLp, [pid])
    }

    startTimestamp(): Promise<ethers.BigNumber> {
        return this.eth_call(functions.startTimestamp, [])
    }
    ...
    stellaPerSec(): Promise<ethers.BigNumber> {
        return this.eth_call(functions.stellaPerSec, [])
    }
