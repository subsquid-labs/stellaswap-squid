...
import * as abi from '../abi/0x2ad0e92461df950e2b1c72e2f7a865c81eaa3ce6'
import {MadUsdcGlmrRewarder2EventAddPool, MadUsdcGlmrRewarder2EventAddRewardInfo, MadUsdcGlmrRewarder2EventOnReward, MadUsdcGlmrRewarder2EventOwnershipTransferred, MadUsdcGlmrRewarder2EventRewardRateUpdated, MadUsdcGlmrRewarder2EventSetPool, MadUsdcGlmrRewarder2EventUpdatePool, MadUsdcGlmrRewarder2FunctionGetTimeElapsed, MadUsdcGlmrRewarder2FunctionUpdatePool0, MadUsdcGlmrRewarder2FunctionAdd, MadUsdcGlmrRewarder2FunctionAddRewardInfo, MadUsdcGlmrRewarder2FunctionEmergencyRewardWithdraw, MadUsdcGlmrRewarder2FunctionInCaseTokensGetStuck, MadUsdcGlmrRewarder2FunctionMassUpdatePools, MadUsdcGlmrRewarder2FunctionOnStellaReward, MadUsdcGlmrRewarder2FunctionRenounceOwnership, MadUsdcGlmrRewarder2FunctionTransferOwnership, MadUsdcGlmrRewarder2FunctionUpdatePool1} from '../model'
import {normalize} from '../util'

export {abi}

export const address = '0x2ad0e92461df950e2b1c72e2f7a865c81eaa3ce6'
    ...
    try {
        switch (item.evmLog.topics[0]) {
            case abi.events['AddPool'].topic: {
                ...
                return new MadUsdcGlmrRewarder2EventAddPool({
                    id: item.evmLog.id,
            ...
            case abi.events['AddRewardInfo'].topic: {
                ...
                return new MadUsdcGlmrRewarder2EventAddRewardInfo({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['OnReward'].topic: {
                ...
                return new MadUsdcGlmrRewarder2EventOnReward({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['OwnershipTransferred'].topic: {
                ...
                return new MadUsdcGlmrRewarder2EventOwnershipTransferred({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RewardRateUpdated'].topic: {
                ...
                return new MadUsdcGlmrRewarder2EventRewardRateUpdated({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['SetPool'].topic: {
                ...
                return new MadUsdcGlmrRewarder2EventSetPool({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['UpdatePool'].topic: {
                ...
                return new MadUsdcGlmrRewarder2EventUpdatePool({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
    ...
    try {
        switch (item.transaction.input.slice(0, 10)) {
            case abi.functions['_getTimeElapsed'].sighash: {
                ...
                return new MadUsdcGlmrRewarder2FunctionGetTimeElapsed({
            ...
            case abi.functions['_updatePool'].sighash: {
                ...
                return new MadUsdcGlmrRewarder2FunctionUpdatePool0({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['add'].sighash: {
                ...
                return new MadUsdcGlmrRewarder2FunctionAdd({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['addRewardInfo'].sighash: {
                ...
                return new MadUsdcGlmrRewarder2FunctionAddRewardInfo({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['emergencyRewardWithdraw'].sighash: {
                ...
                return new MadUsdcGlmrRewarder2FunctionEmergencyRewardWithdraw({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['inCaseTokensGetStuck'].sighash: {
                ...
                return new MadUsdcGlmrRewarder2FunctionInCaseTokensGetStuck({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['massUpdatePools'].sighash: {
                return new MadUsdcGlmrRewarder2FunctionMassUpdatePools({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['onStellaReward'].sighash: {
                ...
                return new MadUsdcGlmrRewarder2FunctionOnStellaReward({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['renounceOwnership'].sighash: {
                return new MadUsdcGlmrRewarder2FunctionRenounceOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['transferOwnership'].sighash: {
                ...
                return new MadUsdcGlmrRewarder2FunctionTransferOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['updatePool'].sighash: {
                ...
                return new MadUsdcGlmrRewarder2FunctionUpdatePool1({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
