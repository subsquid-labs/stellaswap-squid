...
import * as abi from '../abi/0xb4dba7fe6fcc613963d64204fcf789e9e376679a'
import {XStellaGlmrRewarder2NdEventAddPool, XStellaGlmrRewarder2NdEventAddRewardInfo, XStellaGlmrRewarder2NdEventOnReward, XStellaGlmrRewarder2NdEventOwnershipTransferred, XStellaGlmrRewarder2NdEventRewardRateUpdated, XStellaGlmrRewarder2NdEventSetPool, XStellaGlmrRewarder2NdEventUpdatePool, XStellaGlmrRewarder2NdFunctionGetTimeElapsed, XStellaGlmrRewarder2NdFunctionUpdatePool0, XStellaGlmrRewarder2NdFunctionAdd, XStellaGlmrRewarder2NdFunctionAddRewardInfo, XStellaGlmrRewarder2NdFunctionEmergencyRewardWithdraw, XStellaGlmrRewarder2NdFunctionInCaseTokensGetStuck, XStellaGlmrRewarder2NdFunctionMassUpdatePools, XStellaGlmrRewarder2NdFunctionOnStellaReward, XStellaGlmrRewarder2NdFunctionRenounceOwnership, XStellaGlmrRewarder2NdFunctionTransferOwnership, XStellaGlmrRewarder2NdFunctionUpdatePool1} from '../model'
import {normalize} from '../util'

export {abi}

export const address = '0xb4dba7fe6fcc613963d64204fcf789e9e376679a'
    ...
    try {
        switch (item.evmLog.topics[0]) {
            case abi.events['AddPool'].topic: {
                ...
                return new XStellaGlmrRewarder2NdEventAddPool({
                    id: item.evmLog.id,
            ...
            case abi.events['AddRewardInfo'].topic: {
                ...
                return new XStellaGlmrRewarder2NdEventAddRewardInfo({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['OnReward'].topic: {
                ...
                return new XStellaGlmrRewarder2NdEventOnReward({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['OwnershipTransferred'].topic: {
                ...
                return new XStellaGlmrRewarder2NdEventOwnershipTransferred({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RewardRateUpdated'].topic: {
                ...
                return new XStellaGlmrRewarder2NdEventRewardRateUpdated({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['SetPool'].topic: {
                ...
                return new XStellaGlmrRewarder2NdEventSetPool({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['UpdatePool'].topic: {
                ...
                return new XStellaGlmrRewarder2NdEventUpdatePool({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
    ...
    try {
        switch (item.transaction.input.slice(0, 10)) {
            case abi.functions['_getTimeElapsed'].sighash: {
                ...
                return new XStellaGlmrRewarder2NdFunctionGetTimeElapsed({
            ...
            case abi.functions['_updatePool'].sighash: {
                ...
                return new XStellaGlmrRewarder2NdFunctionUpdatePool0({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['add'].sighash: {
                ...
                return new XStellaGlmrRewarder2NdFunctionAdd({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['addRewardInfo'].sighash: {
                ...
                return new XStellaGlmrRewarder2NdFunctionAddRewardInfo({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['emergencyRewardWithdraw'].sighash: {
                ...
                return new XStellaGlmrRewarder2NdFunctionEmergencyRewardWithdraw({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['inCaseTokensGetStuck'].sighash: {
                ...
                return new XStellaGlmrRewarder2NdFunctionInCaseTokensGetStuck({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['massUpdatePools'].sighash: {
                return new XStellaGlmrRewarder2NdFunctionMassUpdatePools({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['onStellaReward'].sighash: {
                ...
                return new XStellaGlmrRewarder2NdFunctionOnStellaReward({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['renounceOwnership'].sighash: {
                return new XStellaGlmrRewarder2NdFunctionRenounceOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['transferOwnership'].sighash: {
                ...
                return new XStellaGlmrRewarder2NdFunctionTransferOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['updatePool'].sighash: {
                ...
                return new XStellaGlmrRewarder2NdFunctionUpdatePool1({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
