...
import * as abi from '../abi/0xf0a2ae65342f143fc09c83e5f19b706abb37414d'
import {Mai4BpWhEventAddLiquidity, Mai4BpWhEventFlashLoan, Mai4BpWhEventNewAdminFee, Mai4BpWhEventNewSwapFee, Mai4BpWhEventOwnershipTransferred, Mai4BpWhEventPaused, Mai4BpWhEventRampA, Mai4BpWhEventRemoveLiquidity, Mai4BpWhEventRemoveLiquidityImbalance, Mai4BpWhEventRemoveLiquidityOne, Mai4BpWhEventStopRampA, Mai4BpWhEventTokenSwap, Mai4BpWhEventUnpaused, Mai4BpWhFunctionAddLiquidity, Mai4BpWhFunctionFlashLoan, Mai4BpWhFunctionInitialize, Mai4BpWhFunctionPause, Mai4BpWhFunctionRampA, Mai4BpWhFunctionRemoveLiquidity, Mai4BpWhFunctionRemoveLiquidityImbalance, Mai4BpWhFunctionRemoveLiquidityOneToken, Mai4BpWhFunctionRenounceOwnership, Mai4BpWhFunctionSetAdminFee, Mai4BpWhFunctionSetFlashLoanFees, Mai4BpWhFunctionSetSwapFee, Mai4BpWhFunctionStopRampA, Mai4BpWhFunctionSwap, Mai4BpWhFunctionToggleFlashLoan, Mai4BpWhFunctionTransferOwnership, Mai4BpWhFunctionUnpause, Mai4BpWhFunctionWithdrawAdminFees} from '../model'
import {normalize} from '../util'

export {abi}

export const address = '0xf0a2ae65342f143fc09c83e5f19b706abb37414d'
    ...
    try {
        switch (item.evmLog.topics[0]) {
            case abi.events['AddLiquidity'].topic: {
                ...
                return new Mai4BpWhEventAddLiquidity({
                    id: item.evmLog.id,
            ...
            case abi.events['FlashLoan'].topic: {
                ...
                return new Mai4BpWhEventFlashLoan({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['NewAdminFee'].topic: {
                ...
                return new Mai4BpWhEventNewAdminFee({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['NewSwapFee'].topic: {
                ...
                return new Mai4BpWhEventNewSwapFee({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['OwnershipTransferred'].topic: {
                ...
                return new Mai4BpWhEventOwnershipTransferred({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['Paused'].topic: {
                ...
                return new Mai4BpWhEventPaused({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RemoveLiquidity'].topic: {
                ...
                return new Mai4BpWhEventRemoveLiquidity({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RemoveLiquidityImbalance'].topic: {
                ...
                return new Mai4BpWhEventRemoveLiquidityImbalance({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RemoveLiquidityOne'].topic: {
                ...
                return new Mai4BpWhEventRemoveLiquidityOne({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['StopRampA'].topic: {
                ...
                return new Mai4BpWhEventStopRampA({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['TokenSwap'].topic: {
                ...
                return new Mai4BpWhEventTokenSwap({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['Unpaused'].topic: {
                ...
                return new Mai4BpWhEventUnpaused({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
    ...
    try {
        switch (item.transaction.input.slice(0, 10)) {
            case abi.functions['addLiquidity'].sighash: {
                ...
                return new Mai4BpWhFunctionAddLiquidity({
            ...
            case abi.functions['flashLoan'].sighash: {
                ...
                return new Mai4BpWhFunctionFlashLoan({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['initialize'].sighash: {
                ...
                return new Mai4BpWhFunctionInitialize({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['pause'].sighash: {
                return new Mai4BpWhFunctionPause({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['rampA'].sighash: {
                ...
                return new Mai4BpWhFunctionRampA({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['removeLiquidity'].sighash: {
                ...
                return new Mai4BpWhFunctionRemoveLiquidity({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['removeLiquidityImbalance'].sighash: {
                ...
                return new Mai4BpWhFunctionRemoveLiquidityImbalance({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['removeLiquidityOneToken'].sighash: {
                ...
                return new Mai4BpWhFunctionRemoveLiquidityOneToken({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['renounceOwnership'].sighash: {
                return new Mai4BpWhFunctionRenounceOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['setAdminFee'].sighash: {
                ...
                return new Mai4BpWhFunctionSetAdminFee({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['setFlashLoanFees'].sighash: {
                ...
                return new Mai4BpWhFunctionSetFlashLoanFees({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['setSwapFee'].sighash: {
                ...
                return new Mai4BpWhFunctionSetSwapFee({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['stopRampA'].sighash: {
                return new Mai4BpWhFunctionStopRampA({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['swap'].sighash: {
                ...
                return new Mai4BpWhFunctionSwap({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['toggleFlashLoan'].sighash: {
                ...
                return new Mai4BpWhFunctionToggleFlashLoan({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['transferOwnership'].sighash: {
                ...
                return new Mai4BpWhFunctionTransferOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['unpause'].sighash: {
                return new Mai4BpWhFunctionUnpause({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['withdrawAdminFees'].sighash: {
                return new Mai4BpWhFunctionWithdrawAdminFees({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
