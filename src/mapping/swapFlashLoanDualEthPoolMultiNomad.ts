...
import * as abi from '../abi/0xb86271571c90ad4e0c9776228437340b42623402'
import {SwapFlashLoanDualEthPoolMultiNomadEventAddLiquidity, SwapFlashLoanDualEthPoolMultiNomadEventFlashLoan, SwapFlashLoanDualEthPoolMultiNomadEventNewAdminFee, SwapFlashLoanDualEthPoolMultiNomadEventNewSwapFee, SwapFlashLoanDualEthPoolMultiNomadEventOwnershipTran, SwapFlashLoanDualEthPoolMultiNomadEventPaused, SwapFlashLoanDualEthPoolMultiNomadEventRampA, SwapFlashLoanDualEthPoolMultiNomadEventRemoveLiquidi0, SwapFlashLoanDualEthPoolMultiNomadEventRemoveLiquidi1, SwapFlashLoanDualEthPoolMultiNomadEventRemoveLiquidi2, SwapFlashLoanDualEthPoolMultiNomadEventStopRampA, SwapFlashLoanDualEthPoolMultiNomadEventTokenSwap, SwapFlashLoanDualEthPoolMultiNomadEventUnpaused, SwapFlashLoanDualEthPoolMultiNomadFunctionAddLiquidi, SwapFlashLoanDualEthPoolMultiNomadFunctionFlashLoan0, SwapFlashLoanDualEthPoolMultiNomadFunctionInitialize, SwapFlashLoanDualEthPoolMultiNomadFunctionPause, SwapFlashLoanDualEthPoolMultiNomadFunctionRampA, SwapFlashLoanDualEthPoolMultiNomadFunctionRemoveLiqu0, SwapFlashLoanDualEthPoolMultiNomadFunctionRemoveLiqu1, SwapFlashLoanDualEthPoolMultiNomadFunctionRemoveLiqu2, SwapFlashLoanDualEthPoolMultiNomadFunctionRenounceOw, SwapFlashLoanDualEthPoolMultiNomadFunctionSetAdminF, SwapFlashLoanDualEthPoolMultiNomadFunctionSetFlashL, SwapFlashLoanDualEthPoolMultiNomadFunctionSetSwapFe, SwapFlashLoanDualEthPoolMultiNomadFunctionStopRampA, SwapFlashLoanDualEthPoolMultiNomadFunctionSwap, SwapFlashLoanDualEthPoolMultiNomadFunctionToggleFlas, SwapFlashLoanDualEthPoolMultiNomadFunctionTransferOw, SwapFlashLoanDualEthPoolMultiNomadFunctionUnpause, SwapFlashLoanDualEthPoolMultiNomadFunctionWithdrawAd} from '../model'
import {normalize} from '../util'

export {abi}

export const address = '0xb86271571c90ad4e0c9776228437340b42623402'
    ...
    try {
        switch (item.evmLog.topics[0]) {
            case abi.events['AddLiquidity'].topic: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadEventAddLiquidity({
                    id: item.evmLog.id,
            ...
            case abi.events['FlashLoan'].topic: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadEventFlashLoan({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['NewAdminFee'].topic: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadEventNewAdminFee({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['NewSwapFee'].topic: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadEventNewSwapFee({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['OwnershipTransferred'].topic: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadEventOwnershipTran({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['Paused'].topic: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadEventPaused({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RampA'].topic: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadEventRampA({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RemoveLiquidity'].topic: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadEventRemoveLiquidi0({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RemoveLiquidityImbalance'].topic: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadEventRemoveLiquidi1({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RemoveLiquidityOne'].topic: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadEventRemoveLiquidi2({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['StopRampA'].topic: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadEventStopRampA({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['TokenSwap'].topic: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadEventTokenSwap({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['Unpaused'].topic: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadEventUnpaused({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
    ...
    try {
        switch (item.transaction.input.slice(0, 10)) {
            case abi.functions['addLiquidity'].sighash: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionAddLiquidi({
            ...
            case abi.functions['flashLoan'].sighash: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionFlashLoan0({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['initialize'].sighash: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionInitialize({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['pause'].sighash: {
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionPause({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['rampA'].sighash: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionRampA({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['removeLiquidity'].sighash: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionRemoveLiqu0({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['removeLiquidityImbalance'].sighash: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionRemoveLiqu1({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['removeLiquidityOneToken'].sighash: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionRemoveLiqu2({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['renounceOwnership'].sighash: {
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionRenounceOw({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['setAdminFee'].sighash: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionSetAdminF({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['setFlashLoanFees'].sighash: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionSetFlashL({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['setSwapFee'].sighash: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionSetSwapFe({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['stopRampA'].sighash: {
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionStopRampA({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['swap'].sighash: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionSwap({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['toggleFlashLoan'].sighash: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionToggleFlas({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['transferOwnership'].sighash: {
                ...
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionTransferOw({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['unpause'].sighash: {
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionUnpause({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['withdrawAdminFees'].sighash: {
                return new SwapFlashLoanDualEthPoolMultiNomadFunctionWithdrawAd({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
