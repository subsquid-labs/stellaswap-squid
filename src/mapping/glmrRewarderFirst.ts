...
import * as abi from '../abi/0x69f9d134991e141c4244f397514ba05d67861cc0'
import {GlmrRewarderFirstEventAddPool, GlmrRewarderFirstEventAddRewardInfo, GlmrRewarderFirstEventOnReward, GlmrRewarderFirstEventOwnershipTransferred, GlmrRewarderFirstEventRewardRateUpdated, GlmrRewarderFirstEventSetPool, GlmrRewarderFirstEventUpdatePool, GlmrRewarderFirstFunctionGetTimeElapsed, GlmrRewarderFirstFunctionUpdatePool0, GlmrRewarderFirstFunctionAdd, GlmrRewarderFirstFunctionAddRewardInfo, GlmrRewarderFirstFunctionEmergencyRewardWithdraw, GlmrRewarderFirstFunctionInCaseTokensGetStuck, GlmrRewarderFirstFunctionMassUpdatePools, GlmrRewarderFirstFunctionOnStellaReward, GlmrRewarderFirstFunctionRenounceOwnership, GlmrRewarderFirstFunctionTransferOwnership, GlmrRewarderFirstFunctionUpdatePool1} from '../model'
import {normalize} from '../util'

export {abi}

export const address = '0x69f9d134991e141c4244f397514ba05d67861cc0'
    ...
    try {
        switch (item.evmLog.topics[0]) {
            case abi.events['AddPool'].topic: {
                ...
                return new GlmrRewarderFirstEventAddPool({
                    id: item.evmLog.id,
            ...
            case abi.events['AddRewardInfo'].topic: {
                ...
                return new GlmrRewarderFirstEventAddRewardInfo({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['OnReward'].topic: {
                ...
                return new GlmrRewarderFirstEventOnReward({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['OwnershipTransferred'].topic: {
                ...
                return new GlmrRewarderFirstEventOwnershipTransferred({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RewardRateUpdated'].topic: {
                ...
                return new GlmrRewarderFirstEventRewardRateUpdated({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['SetPool'].topic: {
                ...
                return new GlmrRewarderFirstEventSetPool({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['UpdatePool'].topic: {
                ...
                return new GlmrRewarderFirstEventUpdatePool({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
    ...
    try {
        switch (item.transaction.input.slice(0, 10)) {
            case abi.functions['_getTimeElapsed'].sighash: {
                ...
                return new GlmrRewarderFirstFunctionGetTimeElapsed({
            ...
            case abi.functions['_updatePool'].sighash: {
                ...
                return new GlmrRewarderFirstFunctionUpdatePool0({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['add'].sighash: {
                ...
                return new GlmrRewarderFirstFunctionAdd({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['addRewardInfo'].sighash: {
                ...
                return new GlmrRewarderFirstFunctionAddRewardInfo({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['emergencyRewardWithdraw'].sighash: {
                ...
                return new GlmrRewarderFirstFunctionEmergencyRewardWithdraw({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['inCaseTokensGetStuck'].sighash: {
                ...
                return new GlmrRewarderFirstFunctionInCaseTokensGetStuck({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['massUpdatePools'].sighash: {
                return new GlmrRewarderFirstFunctionMassUpdatePools({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['onStellaReward'].sighash: {
                ...
                return new GlmrRewarderFirstFunctionOnStellaReward({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['renounceOwnership'].sighash: {
                return new GlmrRewarderFirstFunctionRenounceOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['transferOwnership'].sighash: {
                ...
                return new GlmrRewarderFirstFunctionTransferOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['updatePool'].sighash: {
                ...
                return new GlmrRewarderFirstFunctionUpdatePool1({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
