...
import * as abi from '../abi/0xa1ffdc79f998e7fa91ba3a6f098b84c9275b0483'
import {SflAxlUsdc4PoolEventAddLiquidity, SflAxlUsdc4PoolEventFlashLoan, SflAxlUsdc4PoolEventNewAdminFee, SflAxlUsdc4PoolEventNewSwapFee, SflAxlUsdc4PoolEventOwnershipTransferred, SflAxlUsdc4PoolEventPaused, SflAxlUsdc4PoolEventRampA, SflAxlUsdc4PoolEventRemoveLiquidity, SflAxlUsdc4PoolEventRemoveLiquidityImbalance, SflAxlUsdc4PoolEventRemoveLiquidityOne, SflAxlUsdc4PoolEventStopRampA, SflAxlUsdc4PoolEventTokenSwap, SflAxlUsdc4PoolEventUnpaused, SflAxlUsdc4PoolFunctionAddLiquidity, SflAxlUsdc4PoolFunctionFlashLoan, SflAxlUsdc4PoolFunctionInitialize, SflAxlUsdc4PoolFunctionPause, SflAxlUsdc4PoolFunctionRampA, SflAxlUsdc4PoolFunctionRemoveLiquidity, SflAxlUsdc4PoolFunctionRemoveLiquidityImbalance, SflAxlUsdc4PoolFunctionRemoveLiquidityOneToken, SflAxlUsdc4PoolFunctionRenounceOwnership, SflAxlUsdc4PoolFunctionSetAdminFee, SflAxlUsdc4PoolFunctionSetFlashLoanFees, SflAxlUsdc4PoolFunctionSetSwapFee, SflAxlUsdc4PoolFunctionStopRampA, SflAxlUsdc4PoolFunctionSwap, SflAxlUsdc4PoolFunctionToggleFlashLoan, SflAxlUsdc4PoolFunctionTransferOwnership, SflAxlUsdc4PoolFunctionUnpause, SflAxlUsdc4PoolFunctionWithdrawAdminFees} from '../model'
import {normalize} from '../util'

export {abi}

export const address = '0xa1ffdc79f998e7fa91ba3a6f098b84c9275b0483'
    ...
    try {
        switch (item.evmLog.topics[0]) {
            case abi.events['AddLiquidity'].topic: {
                ...
                return new SflAxlUsdc4PoolEventAddLiquidity({
                    id: item.evmLog.id,
            ...
            case abi.events['FlashLoan'].topic: {
                ...
                return new SflAxlUsdc4PoolEventFlashLoan({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['NewAdminFee'].topic: {
                ...
                return new SflAxlUsdc4PoolEventNewAdminFee({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['NewSwapFee'].topic: {
                ...
                return new SflAxlUsdc4PoolEventNewSwapFee({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['OwnershipTransferred'].topic: {
                ...
                return new SflAxlUsdc4PoolEventOwnershipTransferred({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['Paused'].topic: {
                ...
                return new SflAxlUsdc4PoolEventPaused({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RampA'].topic: {
                ...
                return new SflAxlUsdc4PoolEventRampA({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RemoveLiquidity'].topic: {
                ...
                return new SflAxlUsdc4PoolEventRemoveLiquidity({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RemoveLiquidityImbalance'].topic: {
                ...
                return new SflAxlUsdc4PoolEventRemoveLiquidityImbalance({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RemoveLiquidityOne'].topic: {
                ...
                return new SflAxlUsdc4PoolEventRemoveLiquidityOne({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['StopRampA'].topic: {
                ...
                return new SflAxlUsdc4PoolEventStopRampA({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['TokenSwap'].topic: {
                ...
                return new SflAxlUsdc4PoolEventTokenSwap({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['Unpaused'].topic: {
                ...
                return new SflAxlUsdc4PoolEventUnpaused({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
    ...
    try {
        switch (item.transaction.input.slice(0, 10)) {
            case abi.functions['addLiquidity'].sighash: {
                ...
                return new SflAxlUsdc4PoolFunctionAddLiquidity({
            ...
            case abi.functions['flashLoan'].sighash: {
                ...
                return new SflAxlUsdc4PoolFunctionFlashLoan({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['initialize'].sighash: {
                ...
                return new SflAxlUsdc4PoolFunctionInitialize({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['pause'].sighash: {
                return new SflAxlUsdc4PoolFunctionPause({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['rampA'].sighash: {
                ...
                return new SflAxlUsdc4PoolFunctionRampA({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['removeLiquidity'].sighash: {
                ...
                return new SflAxlUsdc4PoolFunctionRemoveLiquidity({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['removeLiquidityImbalance'].sighash: {
                ...
                return new SflAxlUsdc4PoolFunctionRemoveLiquidityImbalance({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['removeLiquidityOneToken'].sighash: {
                ...
                return new SflAxlUsdc4PoolFunctionRemoveLiquidityOneToken({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['renounceOwnership'].sighash: {
                return new SflAxlUsdc4PoolFunctionRenounceOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['setAdminFee'].sighash: {
                ...
                return new SflAxlUsdc4PoolFunctionSetAdminFee({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['setFlashLoanFees'].sighash: {
                ...
                return new SflAxlUsdc4PoolFunctionSetFlashLoanFees({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['setSwapFee'].sighash: {
                ...
                return new SflAxlUsdc4PoolFunctionSetSwapFee({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['stopRampA'].sighash: {
                return new SflAxlUsdc4PoolFunctionStopRampA({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['swap'].sighash: {
                ...
                return new SflAxlUsdc4PoolFunctionSwap({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['toggleFlashLoan'].sighash: {
                ...
                return new SflAxlUsdc4PoolFunctionToggleFlashLoan({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['transferOwnership'].sighash: {
                ...
                return new SflAxlUsdc4PoolFunctionTransferOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['unpause'].sighash: {
                return new SflAxlUsdc4PoolFunctionUnpause({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['withdrawAdminFees'].sighash: {
                return new SflAxlUsdc4PoolFunctionWithdrawAdminFees({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
