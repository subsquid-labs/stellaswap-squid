...
import * as abi from '../abi/0xcae51da6dceacd84f79df4b88d9f92035d1479e9'
import {WbtcUsdtContractEventAddPool, WbtcUsdtContractEventAddRewardInfo, WbtcUsdtContractEventOnReward, WbtcUsdtContractEventOwnershipTransferred, WbtcUsdtContractEventRewardRateUpdated, WbtcUsdtContractEventSetPool, WbtcUsdtContractEventUpdatePool, WbtcUsdtContractFunctionGetTimeElapsed, WbtcUsdtContractFunctionUpdatePool0, WbtcUsdtContractFunctionAdd, WbtcUsdtContractFunctionAddRewardInfo, WbtcUsdtContractFunctionEmergencyRewardWithdraw, WbtcUsdtContractFunctionInCaseTokensGetStuck, WbtcUsdtContractFunctionMassUpdatePools, WbtcUsdtContractFunctionOnStellaReward, WbtcUsdtContractFunctionRenounceOwnership, WbtcUsdtContractFunctionTransferOwnership, WbtcUsdtContractFunctionUpdatePool1} from '../model'
import {normalize} from '../util'

export {abi}

export const address = '0xcae51da6dceacd84f79df4b88d9f92035d1479e9'
    ...
    try {
        switch (item.evmLog.topics[0]) {
            case abi.events['AddPool'].topic: {
                ...
                return new WbtcUsdtContractEventAddPool({
                    id: item.evmLog.id,
            ...
            case abi.events['AddRewardInfo'].topic: {
                ...
                return new WbtcUsdtContractEventAddRewardInfo({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['OnReward'].topic: {
                ...
                return new WbtcUsdtContractEventOnReward({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['OwnershipTransferred'].topic: {
                ...
                return new WbtcUsdtContractEventOwnershipTransferred({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RewardRateUpdated'].topic: {
                ...
                return new WbtcUsdtContractEventRewardRateUpdated({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['SetPool'].topic: {
                ...
                return new WbtcUsdtContractEventSetPool({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['UpdatePool'].topic: {
                ...
                return new WbtcUsdtContractEventUpdatePool({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
    ...
    try {
        switch (item.transaction.input.slice(0, 10)) {
            case abi.functions['_getTimeElapsed'].sighash: {
                ...
                return new WbtcUsdtContractFunctionGetTimeElapsed({
            ...
            case abi.functions['_updatePool'].sighash: {
                ...
                return new WbtcUsdtContractFunctionUpdatePool0({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['add'].sighash: {
                ...
                return new WbtcUsdtContractFunctionAdd({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['addRewardInfo'].sighash: {
                ...
                return new WbtcUsdtContractFunctionAddRewardInfo({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['emergencyRewardWithdraw'].sighash: {
                ...
                return new WbtcUsdtContractFunctionEmergencyRewardWithdraw({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['inCaseTokensGetStuck'].sighash: {
                ...
                return new WbtcUsdtContractFunctionInCaseTokensGetStuck({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['massUpdatePools'].sighash: {
                return new WbtcUsdtContractFunctionMassUpdatePools({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['onStellaReward'].sighash: {
                ...
                return new WbtcUsdtContractFunctionOnStellaReward({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['renounceOwnership'].sighash: {
                return new WbtcUsdtContractFunctionRenounceOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['transferOwnership'].sighash: {
                ...
                return new WbtcUsdtContractFunctionTransferOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['updatePool'].sighash: {
                ...
                return new WbtcUsdtContractFunctionUpdatePool1({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
