...
import * as abi from '../abi/0xb7b5d3659ad213478bc8bfb94d064d0efdda8f7c'
import {AcalaRewarderEventAddPool, AcalaRewarderEventAddRewardInfo, AcalaRewarderEventOnReward, AcalaRewarderEventOwnershipTransferred, AcalaRewarderEventRewardRateUpdated, AcalaRewarderEventSetPool, AcalaRewarderEventUpdatePool, AcalaRewarderFunctionGetTimeElapsed, AcalaRewarderFunctionUpdatePool0, AcalaRewarderFunctionAdd, AcalaRewarderFunctionAddRewardInfo, AcalaRewarderFunctionEmergencyRewardWithdraw, AcalaRewarderFunctionInCaseTokensGetStuck, AcalaRewarderFunctionMassUpdatePools, AcalaRewarderFunctionOnStellaReward, AcalaRewarderFunctionRenounceOwnership, AcalaRewarderFunctionTransferOwnership, AcalaRewarderFunctionUpdatePool1} from '../model'
import {normalize} from '../util'

export {abi}

export const address = '0xb7b5d3659ad213478bc8bfb94d064d0efdda8f7c'
    ...
    try {
        switch (item.evmLog.topics[0]) {
            case abi.events['AddPool'].topic: {
                ...
                return new AcalaRewarderEventAddPool({
                    id: item.evmLog.id,
            ...
            case abi.events['AddRewardInfo'].topic: {
                ...
                return new AcalaRewarderEventAddRewardInfo({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['OnReward'].topic: {
                ...
                return new AcalaRewarderEventOnReward({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['OwnershipTransferred'].topic: {
                ...
                return new AcalaRewarderEventOwnershipTransferred({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['RewardRateUpdated'].topic: {
                ...
                return new AcalaRewarderEventRewardRateUpdated({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['SetPool'].topic: {
                ...
                return new AcalaRewarderEventSetPool({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.events['UpdatePool'].topic: {
                ...
                return new AcalaRewarderEventUpdatePool({
                    id: item.evmLog.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
    ...
    try {
        switch (item.transaction.input.slice(0, 10)) {
            case abi.functions['_getTimeElapsed'].sighash: {
                ...
                return new AcalaRewarderFunctionGetTimeElapsed({
            ...
            case abi.functions['_updatePool'].sighash: {
                ...
                return new AcalaRewarderFunctionUpdatePool0({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['add'].sighash: {
                ...
                return new AcalaRewarderFunctionAdd({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['addRewardInfo'].sighash: {
                ...
                return new AcalaRewarderFunctionAddRewardInfo({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['emergencyRewardWithdraw'].sighash: {
                ...
                return new AcalaRewarderFunctionEmergencyRewardWithdraw({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['inCaseTokensGetStuck'].sighash: {
                ...
                return new AcalaRewarderFunctionInCaseTokensGetStuck({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['massUpdatePools'].sighash: {
                return new AcalaRewarderFunctionMassUpdatePools({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['onStellaReward'].sighash: {
                ...
                return new AcalaRewarderFunctionOnStellaReward({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['renounceOwnership'].sighash: {
                return new AcalaRewarderFunctionRenounceOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['transferOwnership'].sighash: {
                ...
                return new AcalaRewarderFunctionTransferOwnership({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
            ...
            case abi.functions['updatePool'].sighash: {
                ...
                return new AcalaRewarderFunctionUpdatePool1({
                    id: item.transaction.id,
                    blockNumber: block.height,
                    transactionHash: item.transaction.hash,
                    timestamp: new Date(block.timestamp),
